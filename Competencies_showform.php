	...
	<div class="container-fluid px-1 py-3 mx-auto">
		<div class="row d-flex justify-content-center">
			<div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
				<h3><strong><?php if($cdid1 !=""){ ?> Edit Core Competecies<?php }else  {?>Create Core Competencies <?php } ?></strong></h3>
				<div class="card">
					<?php if($ccid1 !=""){?>
					...
					<form class="form-card" id="acc" onSubmit="event.preventDefault(); <?php if($ccid1!=""){echo "btneditccf(".$ccid1.")";}else echo "btnaddccf()"; ?>">
						<div class="row justify-content-center text-left">
							<div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Core Competency name</label> 
							<div class="col-md-12">
								<textarea id="form_message" name="txtname" class="form-control" placeholder="Write the name here." rows="3" required="required" data-error="Please, leave a name."><?php if($ccid1 != "")echo $row['Cc_name']; ?></textarea> 
								</div>
							</div>
							</div>
							<div class="row justify-content-center text-left">
...
if($_POST['action'] == "showaddcd"){
    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-11 text-center">
            <h3><strong><?php if($cdid1 !=""){ ?> Edit Competencies Dimension<?php }else  {?>Create Competencies Dimension <?php } ?></strong></h3>
            <div class="card">
				<?php if($cdid1 !=""){?>
                ...
                <form class="form-card" id="acd" onSubmit="event.preventDefault(); <?php if($cdid1!=""){echo "btneditcdf(".$cdid1.")";}else echo "btnaddcdf()"; ?>">
					<div class="row justify-content-center text-left">
						<div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Core Competency</label>
							<div class="col-md-12">
					...
					<div class="row justify-content-center text-left">
						<div class="form-group col-sm-6 flex-column d-flex"> <label class="form-control-label px-3">Competencies Dimension Definition</label> 
                        <div class="col-md-12">
                            <textarea id="form_message" name="txtdes" class="form-control" placeholder="Describe here" rows="3" ><?php if($cdid1 !="")echo $row['Cd_Definition']; ?></textarea> 
							</div>
                        </div>
                         </div>
						<div class="row justify-content-center text-left">
