...
<hr class="bdr-light">
<form class="form-card" id="staffexcelform" enctype="multipart/form-data" >
    ...
    <div class="col-10">
      ...
      <input type="file" class="form-control custom-file-input" id="staffexcelid" name="staffexcelname">
