...
<hr class="bdr-light">
<form class="form-card" id="positionexcelform" enctype="multipart/form-data" >
    ...
    <div class="col-10">
      ...
      <input type="file" class="form-control custom-file-input" id="positionexcelid" name="positionexcelname">
